...
class DoclingParser:
    ...
    def _validate_pdf(self,pdf_path:Path)-> bool:
        ...
        try:
            ...
            # Check file exists or empty 
            if pdf_path.stat().st_size ==0:
                logger.error(f'PDF is empty')
    ...
    def parse_pdf(self, pdf_path: Path) -> Optional[PdfContent]:
        ...
        try:
            ...
            """ Example of how Docling might structure the document content:
            doc.texts = [
                Element(label="title", text="Attention Is All You Need"),
                Element(text="This paper introduces the Transformer architecture."),

                Element(label="section_header", text="Introduction"),
                Element(text="Sequence transduction problems are important."),
                Element(text="Recurrent networks have been widely used."),

                Element(label="section_header", text="Methodology"),
                Element(text="We propose a self-attention mechanism."),
                Element(text="The model removes recurrence entirely.")
            ]
            """
            ...
            PaperSection(
                title="Introduction",
                content="
                Sequence transduction problems are important.
                Recurrent networks have been widely used.
                "
            ),
            PaperSection(
                title="Methodology",
                ...
                The model removes recurrence entirely.
                "
            )
            ]
            """
