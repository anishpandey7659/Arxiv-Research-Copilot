...
async def ainvoke_rewrite_query_step(
    ...
    if runtime.context.langfuse_enabled and runtime.context.trace:
        try:
            ...
            logfire.debug("Created Langfuse span for query rewriting")
        except Exception as e:
            logfire.warning(f"Failed to create span for rewrite_query node: {e}")
    ...
    try:
        ...
        logfire.warning("Falling back to simple keyword expansion")
