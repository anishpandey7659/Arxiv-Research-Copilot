...
GENERATE_ANSWER_PROMPT = """Retrieved Research Papers:
{context}

User Question: {question}

Provide a comprehensive answer following your instructions, focusing on key insights from the papers above.

Answer:"""


SYSTEM_PROMPT_ANSWER = """You are an AI research assistant specializing in academic papers from arXiv in Computer Science, AI, and Machine Learning.
