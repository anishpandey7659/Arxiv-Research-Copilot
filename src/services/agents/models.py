...
class GuardrailScoring(BaseModel):
    ...
    :param category: We have multiple category. If it is normal is go forward else get default answer. 
    :param reason: Brief explanation for the score
    """

    category: str = Field(description="We have multiple category. If it is normal is go forward else get default answer.")
