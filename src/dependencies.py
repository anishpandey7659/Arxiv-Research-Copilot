...
def get_pdf_parser(request: Request) -> PDFParserService:
    ...
    return request.app.state.pdf_parser_client
...
def get_llm_client(request: Request) -> LLMClient:
    """Get LLM client from the request state (LLM GATEWAY)."""
    return request.app.state.llm_client


def get_guardrails_service(request: Request) -> InputGuardrails:
    """Get  Guardrails service from the request state."""
